...
public class PhoneBookMain {
	...
	public static void main(String[] args) {
		...
		// PhoneBookManager의 인스턴스 생성 : 배열과 메서드 사용
       ...
       // Scanner sc = new Scanner(System.in);
		...
		/*
		 * // 정보 저장 기능 메서드 호출 manager.insertMember();
		 * 
		 * System.out.println("현재 저장된 정보의 개수 : " + manager.cnt); //
		 * manager.phoneBook[0].showInfor(); //phoneBook이 phoneInfor 타입의 참조변수라서
		 * showInfor()를 불러올 수 있음
		 * 
		 * // 정보 검색 메서드 호출 manager.searchMember();
		 */
        }
