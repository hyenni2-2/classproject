...
public class FriendInfoHandler {
	...
	private int numOfFriends; // 저장된 친구의 정보 개수, 배열의 요소 추가 시 index로 사용
    ...
    public void showAllData() {
		...
		friends[i].showData();    // friends[0] -> Friend 타입의 참조 변수 = 하위 클래스의 인스턴스들을 참조
		System.out.println("--------------------");	
    	}	
    }
	
	
	// 전체 기본 정보를 출력하는 메서드 : show BasicInfo()
