...
-- 가상 테이블 view
-- 실제 테이블을 기반으로 논리적인 가상 테이블을 -> view
...
-- view 정보 확인 : user_views 테이블을 통해 확인 가능, 로그인한 사용자의 view 인스턴스 정보
select view_name, text from user_views;

-- view_emp30을 이용해서 insert
...
-- sequence : 숫자 자동 생성기, 시작값, 증가값, 최대값, 최소값, 반환값
