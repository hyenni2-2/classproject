...
public class GetMessageListService {
	...
	public MessageListView getMessageList(int pageNumber) {
		...
		try {
			...
			// 게시물의 전체 개수 -> 페이지 개수
			int messageTotalCount = dao.selectAllCount(conn);
            ...
            listView = new MessageListView(messageTotalCount, pageNumber, messageList, messageCountPerPage, firstRow, endRow);
