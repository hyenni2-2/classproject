...
function payClick() {
    document.querySelector('.paymain').style.display = 'block';
...
function choosePay(index) {
    ...
    document.querySelector('.paymain').style.display = 'none';

    var payData = JSON.parse(payArr[index]);
    var payHtml = '';

    console.log(payArr[0]);
    console.log(payArr[1]);
    ...
    payHtml += '<img src="../load.gif" height="100" width="100">';
    payHtml += ' </tr></tbody>';
    payHtml += '</table></div>';
